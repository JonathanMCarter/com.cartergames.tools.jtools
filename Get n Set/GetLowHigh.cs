...
namespace JTools.GetSet
{
    ...
    public static class GetLowHigh
    {
        ...
        /// <returns>Int</returns>
        public static int Lowest(int[] toCheck)
        {
        ...
        /// <param name="toCheck">Int Array to check</param>
        /// <returns>Int</returns>
        public static int MedianRoundUp(int[] toCheck)
        {
            var _list = toCheck.ToList();
            _list.Sort();
        ...
        /// <param name="toCheck">Int Array to check</param>
        /// <returns>Int</returns>
        public static int MedianRoundDown(int[] toCheck)
        {
            var _list = toCheck.ToList();
            _list.Sort();
        ...
        /// <param name="toCheck">Int Array to check</param>
        /// <returns>Int</returns>
        public static int Highest(int[] toCheck)
        {
            var _list = toCheck.ToList();
            _list.Sort();
        ...
        {
            int _highestValue = int.MinValue;
            int _highestIndex = -1;

            for (int i = 0; i < toCheck.Count; i++)
            {
                if (toCheck[i] >= _highestValue)
                {
